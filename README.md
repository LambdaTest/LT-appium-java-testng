# How can perform scroll in my automation in TestNG with Appium on [LambdaTest](https://www.lambdatest.com/?utm_source=github&utm_medium=repo&utm_campaign=appium-testNG-scroll)

While performing app automation testing with appium on LambdaTest Grid, you may face a scenario where you would like to scroll through your native or web app. Scrolling can be handled with a test script directly as mentioned below. You can refer to sample test repo [here](https://github.com/LambdaTest/LT-appium-java-testng).

# Steps:

You can scroll using TouchActions as mentioned in the sample below.
